- In order for raw data to become analytics-ready, a number of transformation and cleansing [[Data Wrangling]] tasks need to be performed on raw data. And that requires you to understand your dataset from multiple perspectives. One of the ways in which you can explore your dataset is to query it.
